...
export default function Attributes() {
  ...
  return <>
    ...
    <Stack spacing={2.5}>
      <Stack alignItems={{ xs: "stretch", sm: "center" }} direction={{ xs: "column", sm: "row" }} justifyContent="space-between" gap={2}><Stack alignItems="center" direction="row" spacing={1}><TuneRoundedIcon color="primary" /><Typography variant="h4">Product Attributes</Typography></Stack>{can(USER_PERMISSIONS.PRODUCT_ATTRIBUTES_CREATE) ? <Button onClick={() => openAttribute()} startIcon={<AddRoundedIcon />} variant="contained">New Attribute</Button> : null}</Stack>
