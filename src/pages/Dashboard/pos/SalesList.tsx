...
import { getSale, getSales, type SaleDetail, type SaleListItem } from "../../../redux/slices/posRedux/saleRedux";
...
export default function SalesList() {
  ...
  const load = useCallback(async () => {
    try {
      const response = await getSales({ page: page + 1, pageSize, search: debouncedSearch, status });
  ...
  return <>
    ...
    <Stack spacing={2.5}>
      <Stack alignItems="center" direction="row" justifyContent="space-between">
        ...
        <Typography color="text.secondary" variant="body2">{total} total sales</Typography>
      </Stack>
      <Card sx={{ borderRadius: 3, minHeight: 640, overflow: "hidden" }}>
