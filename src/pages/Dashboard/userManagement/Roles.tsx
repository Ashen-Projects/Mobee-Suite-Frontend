  ...
  return <>
    ...
    <Stack spacing={2.5}>
      <Stack alignItems={{ xs: "stretch", sm: "center" }} direction={{ xs: "column", sm: "row" }} justifyContent="space-between" gap={2}>
        <Stack alignItems="center" direction="row" spacing={1}><AdminPanelSettingsOutlinedIcon color="primary" /><Typography variant="h4">Roles & Permissions</Typography></Stack>
