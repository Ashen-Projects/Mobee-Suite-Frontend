...
export const addGrnDocuments = async (id: number, documents: GrnDocumentInput[]) => (await post<GrnDetail, { documents: GrnDocumentInput[] }>(`grns/${id}/documents`, { documents }, undefined, false)).data;
