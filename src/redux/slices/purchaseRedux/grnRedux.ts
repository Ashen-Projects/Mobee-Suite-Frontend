...
export const addGrnStock = async (id: number, items: Array<{ grnItemId: number; units: GrnUnit[] }>) => (await post<GrnDetail, { items: Array<{ grnItemId: number; units: GrnUnit[] }> }>(`grns/${id}/add-to-stock`, { items }, undefined, false)).data;
